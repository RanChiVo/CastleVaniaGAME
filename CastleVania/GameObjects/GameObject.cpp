...
//
//		if (c->get_t() < min_tx && c->get_nx() != 0) {
//			min_tx = c->get_t(); nx = c->get_nx(); min_ix = i;
//		}
//
//		if (c->get_t() < min_ty  && c->get_ny() != 0) {
//			min_ty = c->get_t(); ny = c->get_ny(); min_iy = i;
//		}
//	}
//
