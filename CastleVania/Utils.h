...
class Utils
{
	...
	std::unordered_map<std::string, EntityID> stringToEntityID = {
		...
		{"ID_ENTITY_MAP_END",EntityID::ID_ENTITY_MAP_END },
		...
		{"ID_ENTITY_DOUBLE_SHOOT",EntityID::ID_ENTITY_DOUBLE_SHOOT },
		...
		{"ID_ENTITY_BONE", EntityID::ID_ENTITY_BONE},
		{"ID_ENTITY_RAVEN", EntityID::ID_ENTITY_RAVEN},
		{"ID_ENTITY_DEATH_FLOOR", EntityID::ID_ENTITY_DEATH_FLOOR},
	};
	...
	std::unordered_map<std::string, ANI_ID> stringToAniID = {
		...
		{"SIMON_ANI_WIN", ANI_ID::SIMON_ANI_WIN},
		...
		{"BRICK_ANI5", ANI_ID::BRICK_ANI5},
		{"BRICK_ANI6", ANI_ID::BRICK_ANI6},
		...
		{"WHITE_SKELETON_THROW_BONE_ANI", ANI_ID::WHITE_SKELETON_THROW_BONE_ANI},
		{"RAVEN_ANI_IDLE", ANI_ID::RAVEN_ANI_IDLE},
		{"RAVEN_ANI_FLY", ANI_ID::RAVEN_ANI_FLY},
		{"DOUBLE_SHOOT_ANI", ANI_ID::DOUBLE_SHOOT_ANI},
	};
